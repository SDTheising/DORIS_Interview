...
df = df.filter(pl.col("Type_clean") == "Private Office")
...
plt.ylabel("% of Offices Occupied")
plt.title("Hourly Usage Rate of Private Office")
plt.xticks(hourly_pct["hour"])
plt.tight_layout()
plt.savefig("./visuals/priv_off_hourly.png", dpi=300)
plt.show()
